...
var InsuranceEngine = (function() {
  ...
  // 可变产品库（可被 setProducts 覆盖，保留 DEFAULT_PRODUCTS 作为兜底）
  ...
  function scoreProduct(product, member, gapPriority) {
    ...
    // 综合：价格×0.3 + 健告×0.2 + 延续×0.25 + 公司×0.25
    return {
